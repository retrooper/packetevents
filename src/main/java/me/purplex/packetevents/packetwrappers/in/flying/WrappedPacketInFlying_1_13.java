...
class WrappedPacketInFlying_1_13 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    WrappedPacketInFlying_1_13(Object packet) {
        super(packet);
    }
    ...
    static class WrappedPacketInPosition_1_13 extends WrappedPacketInFlying_1_13 {

        WrappedPacketInPosition_1_13(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    static class WrappedPacketInPosition_Look_1_13 extends WrappedPacketInFlying_1_13 {

        WrappedPacketInPosition_Look_1_13(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
