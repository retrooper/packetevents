...
public class WrappedPacketPlayInFlying_1_13 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    public WrappedPacketPlayInFlying_1_13(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketPlayInPosition_1_13 extends WrappedPacketPlayInFlying_1_13 {

        public WrappedPacketPlayInPosition_1_13(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketPlayInPosition_Look_1_13 extends WrappedPacketPlayInFlying_1_13 {

        public WrappedPacketPlayInPosition_Look_1_13(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
