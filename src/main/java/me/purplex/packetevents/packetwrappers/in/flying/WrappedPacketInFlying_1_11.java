...
class WrappedPacketInFlying_1_11 extends WrappedVersionPacket {
    ...
    WrappedPacketInFlying_1_11(Object packet) {
        super(packet);
    }
    ...
    static class WrappedPacketInPosition_1_11 extends WrappedPacketInFlying_1_11 {

        WrappedPacketInPosition_1_11(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    static class WrappedPacketInPosition_Look_1_11 extends WrappedPacketInFlying_1_11 {

        WrappedPacketInPosition_Look_1_11(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
