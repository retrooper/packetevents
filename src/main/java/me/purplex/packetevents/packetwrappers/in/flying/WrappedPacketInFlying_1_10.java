...
class WrappedPacketInFlying_1_10 extends WrappedVersionPacket {
    ...
    WrappedPacketInFlying_1_10(Object packet) {
        super(packet);
    }
    ...
    static class WrappedPacketInPosition_1_10 extends WrappedPacketInFlying_1_10 {

        WrappedPacketInPosition_1_10(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    static class WrappedPacketInPosition_Look_1_10 extends WrappedPacketInFlying_1_10 {

        WrappedPacketInPosition_Look_1_10(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
