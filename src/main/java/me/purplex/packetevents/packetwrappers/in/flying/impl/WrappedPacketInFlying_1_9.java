...
public class WrappedPacketInFlying_1_9 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    public WrappedPacketInFlying_1_9(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketInPosition_1_9 extends WrappedPacketInFlying_1_9 {

        public WrappedPacketInPosition_1_9(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketInPosition_Look_1_9 extends WrappedPacketInFlying_1_9 {

        public WrappedPacketInPosition_Look_1_9(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
