...
public class WrappedPacketInFlying_1_9_4 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    public WrappedPacketInFlying_1_9_4(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketInPosition_1_9_4 extends WrappedPacketInFlying_1_9_4 {

        public WrappedPacketInPosition_1_9_4(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketInPosition_Look_1_9_4 extends WrappedPacketInFlying_1_9_4 {

        public WrappedPacketInPosition_Look_1_9_4(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
