...
public class WrappedPacketInFlying_1_11 extends WrappedVersionPacket {
    ...
    public WrappedPacketInFlying_1_11(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketInPosition_1_11 extends WrappedPacketInFlying_1_11 {

        public WrappedPacketInPosition_1_11(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketInPosition_Look_1_11 extends WrappedPacketInFlying_1_11 {

        public WrappedPacketInPosition_Look_1_11(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
