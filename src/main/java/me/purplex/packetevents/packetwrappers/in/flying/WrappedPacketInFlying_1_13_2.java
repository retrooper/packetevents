...
class WrappedPacketInFlying_1_13_2 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    WrappedPacketInFlying_1_13_2(Object packet) {
        super(packet);
    }
    ...
    static class WrappedPacketInPosition_1_13_2 extends WrappedPacketInFlying_1_13_2 {

        WrappedPacketInPosition_1_13_2(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    static class WrappedPacketInPosition_Look_1_13_2 extends WrappedPacketInFlying_1_13_2 {

        WrappedPacketInPosition_Look_1_13_2(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
