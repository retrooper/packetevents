...
public class WrappedPacketInFlying_1_10 extends WrappedVersionPacket {
    ...
    public WrappedPacketInFlying_1_10(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketInPosition_1_10 extends WrappedPacketInFlying_1_10 {

        public WrappedPacketInPosition_1_10(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketInPosition_Look_1_10 extends WrappedPacketInFlying_1_10 {

        public WrappedPacketInPosition_Look_1_10(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
