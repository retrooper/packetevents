...
class WrappedPacketInFlying_1_9_4 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    WrappedPacketInFlying_1_9_4(Object packet) {
        super(packet);
    }
    ...
    static class WrappedPacketInPosition_1_9_4 extends WrappedPacketInFlying_1_9_4 {

        WrappedPacketInPosition_1_9_4(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    static class WrappedPacketInPosition_Look_1_9_4 extends WrappedPacketInFlying_1_9_4 {

        WrappedPacketInPosition_Look_1_9_4(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
