...
public class WrappedPacketInFlying_1_13_2 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    public WrappedPacketInFlying_1_13_2(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketInPosition_1_13_2 extends WrappedPacketInFlying_1_13_2 {

        public WrappedPacketInPosition_1_13_2(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketInPosition_Look_1_13_2 extends WrappedPacketInFlying_1_13_2 {

        public WrappedPacketInPosition_Look_1_13_2(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
