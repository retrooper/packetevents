...
public class WrappedPacketInFlying_1_15 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    public WrappedPacketInFlying_1_15(Object packet) {
        super(packet);
    }
    ...
    public static class WrappedPacketInPosition_1_15 extends WrappedPacketInFlying_1_15 {

        public WrappedPacketInPosition_1_15(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    public static class WrappedPacketInPosition_Look_1_15 extends WrappedPacketInFlying_1_15 {

        public WrappedPacketInPosition_Look_1_15(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
