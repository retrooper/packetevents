...
class WrappedPacketInFlying_1_12 extends WrappedVersionPacket {
    public double x;
    public double y;
    public double z;
    public float yaw;
    ...
    WrappedPacketInFlying_1_12(Object packet) {
        super(packet);
    }
    ...
    static class WrappedPacketInPosition_1_12 extends WrappedPacketInFlying_1_12 {

        WrappedPacketInPosition_1_12(Object packet) {
            super(packet);
            this.hasPos = true;
        }
    }

    static class WrappedPacketInPosition_Look_1_12 extends WrappedPacketInFlying_1_12 {

        WrappedPacketInPosition_Look_1_12(Object packet) {
            super(packet);
            this.hasLook = true;
        }
    }
