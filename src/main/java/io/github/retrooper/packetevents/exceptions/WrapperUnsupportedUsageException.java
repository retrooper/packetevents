 ...
 * We override a {@link ReflectionObject#isSupported()} method if it isn't supported on all server versions.
 *
 * @author retrooper
 * @see ReflectionObject#isSupported()
 * @see ReflectionObject.SupportedVersions
 * @since 1.7
 */
public class WrapperUnsupportedUsageException extends RuntimeException {
    ...
    public WrapperUnsupportedUsageException(Class<? extends ReflectionObject> wrapperClass) {
