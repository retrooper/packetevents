...
import io.github.retrooper.packetevents.utils.chunk.palette.GlobalPalette;
import io.github.retrooper.packetevents.utils.chunk.palette.ListPalette;
import io.github.retrooper.packetevents.utils.chunk.palette.MapPalette;
import io.github.retrooper.packetevents.utils.chunk.palette.Palette;
...
public class Chunk {
    ...
    public static Chunk read(PacketWrapper<?> in) throws IOException {
    ...
    public static void write(PacketWrapper<?> out, Chunk chunk) throws IOException {
