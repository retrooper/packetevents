...
public class PacketPostDecoderModern extends ByteToMessageDecoder {
    ...
    public PacketPostDecoderModern(Channel channel) {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf byteBuf, List<Object> list) throws Exception {
        ...
        try {
            DECODE_METHOD.invoke(channel.pipeline().get("decoder"), ctx, byteBuf, list);
