 ...
 *
 * Replaced in 1.17 with the more efficient {@link WrapperGameServerPing}
 *
 * @see io.github.retrooper.packetevents.wrapper.game.client.WrappedGameClientWindowConfirmation
 */
public class WrappedGameServerWindowConfirmation extends PacketWrapper<WrappedGameServerWindowConfirmation> {
    byte windowID;
    short actionID;
    boolean accepted;

    public WrappedGameServerWindowConfirmation(PacketSendEvent event) {
        super(event);
    }
     ...
     */
    public WrappedGameServerWindowConfirmation(byte windowID, short actionID, boolean accepted) {
        super(PacketType.Game.Server.WINDOW_CONFIRMATION.getID());
    ...
    @Override
    public void readData(WrappedGameServerWindowConfirmation wrapper) {
