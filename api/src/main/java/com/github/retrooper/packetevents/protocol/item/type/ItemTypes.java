...
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.ATTRIBUTE_MODIFIERS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.BANNER_PATTERNS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.BEES;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.BUCKET_ENTITY_DATA;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.BUNDLE_CONTENTS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.CHARGED_PROJECTILES;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.CONTAINER;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.DAMAGE;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.ENCHANTMENT_GLINT_OVERRIDE;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.FIREWORKS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.FIRE_RESISTANT;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.FOOD;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.MAP_COLOR;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.MAX_DAMAGE;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.MAX_STACK_SIZE;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.OMINOUS_BOTTLE_AMPLIFIER;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.POTION_CONTENTS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.POT_DECORATIONS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.RARITY;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.STORED_ENCHANTMENTS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.SUSPICIOUS_STEW_EFFECTS;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.TOOL;
import static com.github.retrooper.packetevents.protocol.item.component.ComponentTypes.WRITABLE_BOOK_CONTENT;
...
public class ItemTypes {
    ...
    public static final ItemType GOLDEN_AXE = builder("golden_axe").setMaxAmount(1).setMaxDurability(32).setAttributes(ItemAttribute.GOLD_TIER, ItemAttribute.AXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 6.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_gold_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/axe")), 12.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType NETHERITE_AXE = builder("netherite_axe").setMaxAmount(1).setMaxDurability(2031).setAttributes(ItemAttribute.FIRE_RESISTANT, ItemAttribute.NETHERITE_TIER, ItemAttribute.AXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 9.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(FIRE_RESISTANT, null).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_netherite_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/axe")), 9.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType WOODEN_PICKAXE = builder("wooden_pickaxe").setMaxAmount(1).setMaxDurability(59).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL, ItemAttribute.PICKAXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 1.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.8d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_wooden_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/pickaxe")), 2.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType DIAMOND_PICKAXE = builder("diamond_pickaxe").setMaxAmount(1).setMaxDurability(1561).setAttributes(ItemAttribute.DIAMOND_TIER, ItemAttribute.PICKAXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 4.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.8d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_diamond_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/pickaxe")), 8.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType IRON_SWORD = builder("iron_sword").setMaxAmount(1).setMaxDurability(250).setAttributes(ItemAttribute.IRON_TIER, ItemAttribute.SWORD).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 5.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(Arrays.asList(StateTypes.COBWEB.getMapped())), 15.0f, true), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("sword_efficient")), 1.5f, null)), 1.0f, 2)).build();
    ...
    public static final ItemType IRON_HOE = builder("iron_hoe").setMaxAmount(1).setMaxDurability(250).setAttributes(ItemAttribute.IRON_TIER, ItemAttribute.HOE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -1.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_iron_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/hoe")), 6.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType NETHERITE_HOE = builder("netherite_hoe").setMaxAmount(1).setMaxDurability(2031).setAttributes(ItemAttribute.FIRE_RESISTANT, ItemAttribute.NETHERITE_TIER, ItemAttribute.HOE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(FIRE_RESISTANT, null).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_netherite_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/hoe")), 9.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType WOODEN_HOE = builder("wooden_hoe").setMaxAmount(1).setMaxDurability(59).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL, ItemAttribute.HOE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_wooden_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/hoe")), 2.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType WOODEN_SHOVEL = builder("wooden_shovel").setMaxAmount(1).setMaxDurability(59).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL, ItemAttribute.SHOVEL).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 1.5d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_wooden_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/shovel")), 2.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType TRIDENT = builder("trident").setMaxAmount(1).setMaxDurability(250).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 8.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.9d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Collections.emptyList(), 1.0f, 2)).build();
    ...
    public static final ItemType DIAMOND_SHOVEL = builder("diamond_shovel").setMaxAmount(1).setMaxDurability(1561).setAttributes(ItemAttribute.DIAMOND_TIER, ItemAttribute.SHOVEL).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 4.5d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_diamond_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/shovel")), 8.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType NETHERITE_SHOVEL = builder("netherite_shovel").setMaxAmount(1).setMaxDurability(2031).setAttributes(ItemAttribute.FIRE_RESISTANT, ItemAttribute.NETHERITE_TIER, ItemAttribute.SHOVEL).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 5.5d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(FIRE_RESISTANT, null).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_netherite_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/shovel")), 9.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType GOLDEN_SWORD = builder("golden_sword").setMaxAmount(1).setMaxDurability(32).setAttributes(ItemAttribute.GOLD_TIER, ItemAttribute.SWORD).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(Arrays.asList(StateTypes.COBWEB.getMapped())), 15.0f, true), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("sword_efficient")), 1.5f, null)), 1.0f, 2)).build();
    ...
    public static final ItemType GOLDEN_SHOVEL = builder("golden_shovel").setMaxAmount(1).setMaxDurability(32).setAttributes(ItemAttribute.GOLD_TIER, ItemAttribute.SHOVEL).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 1.5d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_gold_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/shovel")), 12.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType NETHERITE_SWORD = builder("netherite_sword").setMaxAmount(1).setMaxDurability(2031).setAttributes(ItemAttribute.FIRE_RESISTANT, ItemAttribute.NETHERITE_TIER, ItemAttribute.SWORD).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 7.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(FIRE_RESISTANT, null).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(Arrays.asList(StateTypes.COBWEB.getMapped())), 15.0f, true), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("sword_efficient")), 1.5f, null)), 1.0f, 2)).build();
    ...
    public static final ItemType WOODEN_SWORD = builder("wooden_sword").setMaxAmount(1).setMaxDurability(59).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL, ItemAttribute.SWORD).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(Arrays.asList(StateTypes.COBWEB.getMapped())), 15.0f, true), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("sword_efficient")), 1.5f, null)), 1.0f, 2)).build();
    ...
    public static final ItemType STONE_PICKAXE = builder("stone_pickaxe").setMaxAmount(1).setMaxDurability(131).setAttributes(ItemAttribute.STONE_TIER, ItemAttribute.PICKAXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 2.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.8d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_stone_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/pickaxe")), 4.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType STONE_SHOVEL = builder("stone_shovel").setMaxAmount(1).setMaxDurability(131).setAttributes(ItemAttribute.STONE_TIER, ItemAttribute.SHOVEL).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 2.5d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_stone_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/shovel")), 4.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType DIAMOND_SWORD = builder("diamond_sword").setMaxAmount(1).setMaxDurability(1561).setAttributes(ItemAttribute.DIAMOND_TIER, ItemAttribute.SWORD).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 6.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(Arrays.asList(StateTypes.COBWEB.getMapped())), 15.0f, true), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("sword_efficient")), 1.5f, null)), 1.0f, 2)).build();
    ...
    public static final ItemType DIAMOND_AXE = builder("diamond_axe").setMaxAmount(1).setMaxDurability(1561).setAttributes(ItemAttribute.DIAMOND_TIER, ItemAttribute.AXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 8.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_diamond_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/axe")), 8.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType NETHERITE_PICKAXE = builder("netherite_pickaxe").setMaxAmount(1).setMaxDurability(2031).setAttributes(ItemAttribute.FIRE_RESISTANT, ItemAttribute.NETHERITE_TIER, ItemAttribute.PICKAXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 5.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.8d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(FIRE_RESISTANT, null).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_netherite_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/pickaxe")), 9.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType IRON_SHOVEL = builder("iron_shovel").setMaxAmount(1).setMaxDurability(250).setAttributes(ItemAttribute.IRON_TIER, ItemAttribute.SHOVEL).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 3.5d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_iron_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/shovel")), 6.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType WOODEN_AXE = builder("wooden_axe").setMaxAmount(1).setMaxDurability(59).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL, ItemAttribute.AXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 6.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.2d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_wooden_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/axe")), 2.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType GOLDEN_PICKAXE = builder("golden_pickaxe").setMaxAmount(1).setMaxDurability(32).setAttributes(ItemAttribute.GOLD_TIER, ItemAttribute.PICKAXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 1.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.8d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_gold_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/pickaxe")), 12.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType STONE_AXE = builder("stone_axe").setMaxAmount(1).setMaxDurability(131).setAttributes(ItemAttribute.STONE_TIER, ItemAttribute.AXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 8.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.2d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_stone_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/axe")), 4.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType STONE_SWORD = builder("stone_sword").setMaxAmount(1).setMaxDurability(131).setAttributes(ItemAttribute.STONE_TIER, ItemAttribute.SWORD).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 4.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(Arrays.asList(StateTypes.COBWEB.getMapped())), 15.0f, true), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("sword_efficient")), 1.5f, null)), 1.0f, 2)).build();
    ...
    public static final ItemType IRON_AXE = builder("iron_axe").setMaxAmount(1).setMaxDurability(250).setAttributes(ItemAttribute.IRON_TIER, ItemAttribute.AXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 8.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.1d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_iron_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/axe")), 6.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType GOLDEN_HOE = builder("golden_hoe").setMaxAmount(1).setMaxDurability(32).setAttributes(ItemAttribute.GOLD_TIER, ItemAttribute.HOE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_gold_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/hoe")), 12.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType STONE_HOE = builder("stone_hoe").setMaxAmount(1).setMaxDurability(131).setAttributes(ItemAttribute.STONE_TIER, ItemAttribute.HOE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_stone_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/hoe")), 4.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType DIAMOND_HOE = builder("diamond_hoe").setMaxAmount(1).setMaxDurability(1561).setAttributes(ItemAttribute.DIAMOND_TIER, ItemAttribute.HOE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", 0.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_diamond_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/hoe")), 8.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType IRON_PICKAXE = builder("iron_pickaxe").setMaxAmount(1).setMaxDurability(250).setAttributes(ItemAttribute.IRON_TIER, ItemAttribute.PICKAXE).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Tool modifier", 3.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Tool modifier", -2.8d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Arrays.asList(new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("incorrect_for_iron_tool")), null, false), new ItemTool.Rule(new MappedEntitySet<>(ResourceLocation.minecraft("mineable/pickaxe")), 6.0f, true)), 1.0f, 1)).build();
    ...
    public static final ItemType MACE = builder("mace").setMaxAmount(1).setMaxDurability(250).setComponent(DAMAGE, 0).setComponent(ATTRIBUTE_MODIFIERS, new ItemAttributeModifiers(Arrays.asList(new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_DAMAGE, new ItemAttributeModifiers.Modifier(UUID.fromString("cb3f55d3-645c-4f38-a497-9c13a33db5cf"), "Weapon modifier", 6.0d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND), new ItemAttributeModifiers.ModifierEntry(Attributes.GENERIC_ATTACK_SPEED, new ItemAttributeModifiers.Modifier(UUID.fromString("fa233e1c-4180-4865-b01b-bcce9785aca3"), "Weapon modifier", -2.4d, AttributeOperation.ADDITION), ItemAttributeModifiers.EquipmentSlotGroup.MAINHAND)), true)).setComponent(TOOL, new ItemTool(Collections.emptyList(), 1.0f, 2)).build();
