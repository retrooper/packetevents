 ...
 */
@NullMarked
public final class BiasedToBottomInt implements IntProvider {

    public static final NbtMapCodec<BiasedToBottomInt> MAP_CODEC = new NbtMapCodec<BiasedToBottomInt>() {
        @Override
        public BiasedToBottomInt decode(NBTCompound tag, PacketWrapper<?> wrapper) throws NbtCodecException {
        ...
        @Override
        public void encode(NBTCompound tag, PacketWrapper<?> wrapper, BiasedToBottomInt value) throws NbtCodecException {
    ...
    public IntProviderType<?> getType() {
        return IntProviderTypes.BIASED_TO_BOTTOM;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        BiasedToBottomInt that = (BiasedToBottomInt) obj;
