 ...
 */
@NullMarked
public final class SolidPredicate extends StateTestingPredicate {

    public static final NbtMapCodec<SolidPredicate> MAP_CODEC = OFFSET_CODEC
            .apply(SolidPredicate::new, StateTestingPredicate::getOffset);

    public SolidPredicate(Vector3i offset) {
        super(offset);
    }

    @Override
    public BlockPredicateType<?> getType() {
        return BlockPredicateTypes.SOLID;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        SolidPredicate that = (SolidPredicate) obj;
