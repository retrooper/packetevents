...
public class BlockTags {
     ...
     * Added with 1.21.5
     */
    public static final BlockTags PLAYS_AMBIENT_DESERT_BLOCK_SOUNDS = bind("plays_ambient_desert_block_sounds");
    ...
    static {
        ...
        BlockTags.PLAYS_AMBIENT_DESERT_BLOCK_SOUNDS.addTag(BlockTags.TERRACOTTA).add(StateTypes.SAND, StateTypes.RED_SAND);
        ...
        BlockTags.WALL_POST_OVERRIDE.addTag(BlockTags.SIGNS).addTag(BlockTags.BANNERS).addTag(BlockTags.PRESSURE_PLATES).add(StateTypes.TORCH, StateTypes.SOUL_TORCH, StateTypes.REDSTONE_TORCH, StateTypes.TRIPWIRE, StateTypes.CACTUS_FLOWER);
