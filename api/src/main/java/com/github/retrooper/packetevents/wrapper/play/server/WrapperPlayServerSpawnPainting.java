...
public class WrapperPlayServerSpawnPainting extends PacketWrapper<WrapperPlayServerSpawnPainting> {
    ...
    public WrapperPlayServerSpawnPainting(int entityId, @Nullable String title, Vector3i position, Direction direction) {
    ...
    public WrapperPlayServerSpawnPainting(int entityId, @Nullable UUID uuid, @Nullable String title, Vector3i position, Direction direction) {
        super(PacketType.Play.Server.SPAWN_PAINTING);
        this.entityId = entityId;
        this.uuid = uuid;
        this.title = title;
    ...
    public WrapperPlayServerSpawnPainting(int entityId, @Nullable UUID uuid, @Nullable String title, @Nullable PaintingType type, Vector3i position, Direction direction) {
        super(PacketType.Play.Server.SPAWN_PAINTING);
        this.entityId = entityId;
        this.uuid = uuid;
        this.title = title;
