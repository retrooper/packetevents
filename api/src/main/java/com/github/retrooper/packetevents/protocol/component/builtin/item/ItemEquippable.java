...
public class ItemEquippable {
    ...
    public static ItemEquippable read(PacketWrapper<?> wrapper) {
        EquipmentSlot slot = EquipmentSlot.getByComponentId(wrapper.getServerVersion(), wrapper.readVarInt());
    ...
    public static void write(PacketWrapper<?> wrapper, ItemEquippable equippable) {
        wrapper.writeVarInt(equippable.slot.getComponentId(wrapper.getServerVersion()));
