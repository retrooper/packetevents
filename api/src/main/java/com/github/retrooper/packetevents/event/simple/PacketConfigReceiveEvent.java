...
public class PacketConfigReceiveEvent extends PacketReceiveEvent {
    ...
    public PacketConfigReceiveEvent(Object channel, User user,
    ...
    protected PacketConfigReceiveEvent(int packetId, PacketTypeCommon packetType,
    ...
    public PacketConfigReceiveEvent clone() {
        try {
            ...
            return new PacketConfigReceiveEvent(getPacketId(), getPacketType(), getServerVersion(),
