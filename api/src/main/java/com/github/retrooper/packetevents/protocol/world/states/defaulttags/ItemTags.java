...
public class ItemTags {
     ...
     * @versions 1.21.9+
     */
    public static final ItemTags WOODEN_SHELVES = bind("wooden_shelves");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags COPPER_CHESTS = bind("copper_chests");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags LIGHTNING_RODS = bind("lightning_rods");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags COPPER_GOLEM_STATUES = bind("copper_golem_statues");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags COPPER = bind("copper");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags CHAINS = bind("chains");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags LANTERNS = bind("lanterns");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags BARS = bind("bars");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags COPPER_TOOL_MATERIALS = bind("copper_tool_materials");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags REPAIRS_COPPER_ARMOR = bind("repairs_copper_armor");
    /**
     * @versions 1.21.9+
     */
    public static final ItemTags SHEARABLE_FROM_COPPER_GOLEM = bind("shearable_from_copper_golem");
     ...
     * @versions 1.21.11+
     */
    public static final ItemTags CAMEL_HUSK_FOOD = bind("camel_husk_food");
    /**
     * @versions 1.21.11+
     */
    public static final ItemTags NAUTILUS_BUCKET_FOOD = bind("nautilus_bucket_food");
    /**
     * @versions 1.21.11+
     */
    public static final ItemTags NAUTILUS_TAMING_ITEMS = bind("nautilus_taming_items");
    /**
     * @versions 1.21.11+
     */
    public static final ItemTags SPEARS = bind("spears");
    /**
     * @versions 1.21.11+
     */
    public static final ItemTags NAUTILUS_FOOD = bind("nautilus_food");
    /**
     * @versions 1.21.11+
     */
    public static final ItemTags ENCHANTABLE_MELEE_WEAPON = bind("enchantable/melee_weapon");
    /**
     * @versions 1.21.11+
     */
    public static final ItemTags ENCHANTABLE_SWEEPING = bind("enchantable/sweeping");
    /**
     * @versions 1.21.11+
     */
     ...
     * @versions 26.3+
     */
    public static final ItemTags MUSHROOMS = bind("mushrooms");
    /**
     * @versions 26.3+
     */
    public static final ItemTags CLONABLE_MAPS = bind("clonable_maps");
    /**
     * @versions 26.3+
     */
    public static final ItemTags EXTENDABLE_MAPS = bind("extendable_maps");
    /**
     * @versions 26.3+
     */
    public static final ItemTags CUSHIONS = bind("cushions");
    /**
     * @versions 26.3+
     */
    public static final ItemTags DOUSES_CAMPFIRES = bind("douses_campfires");
    /**
     * @versions 26.3+
     */
    public static final ItemTags BREWING_POTION_INPUTS = bind("brewing_potion_inputs");
    /**
     * @versions 26.3+
     */
    public static final ItemTags FURNACE_FUEL_BOTTOM_TAKEABLE = bind("furnace_fuel_bottom_takeable");
    /**
     * @versions 26.3+
     */
    public static final ItemTags POPLAR_LOGS = bind("poplar_logs");
    /**
     * @versions 26.3+
     */
    public static final ItemTags ORES = bind("ores");
    /**
     * @versions 26.3+
     */
    public static final ItemTags CONCRETE_STAIRS = bind("concrete_stairs");
    /**
     * @versions 26.3+
     */
    public static final ItemTags CONCRETE_SLABS = bind("concrete_slabs");
    /**
     * @versions 26.3+
     */
    public static final ItemTags WOOL_STAIRS = bind("wool_stairs");
    /**
     * @versions 26.3+
     */
    public static final ItemTags WOOL_SLABS = bind("wool_slabs");
    ...
    static {
        ...
        copy(BlockTags.WOOL_STAIRS, ItemTags.WOOL_STAIRS);
        copy(BlockTags.WOOL_SLABS, ItemTags.WOOL_SLABS);
        ...
        copy(BlockTags.POPLAR_LOGS, ItemTags.POPLAR_LOGS);
        ...
        copy(BlockTags.TRIGGERS_AMBIENT_DESERT_SAND_BLOCK_SOUNDS, ItemTags.SMELTS_TO_GLASS);
        ...
        copy(BlockTags.CONCRETE_STAIRS, ItemTags.CONCRETE_STAIRS);
        copy(BlockTags.CONCRETE_SLABS, ItemTags.CONCRETE_SLABS);
        ...
        copy(BlockTags.SKULLS, ItemTags.SKULLS);
        ...
        copy(BlockTags.CAUSES_PERIODIC_GEYSER_ERUPTIONS, ItemTags.SULFUR_CUBE_ARCHETYPE_HOT);
        ...
        ItemTags.MUSHROOMS.add(ItemTypes.BROWN_MUSHROOM, ItemTypes.RED_MUSHROOM, ItemTypes.SHELF_MUSHROOM);
        ...
        ItemTags.CLONABLE_MAPS.add(ItemTypes.FILLED_MAP, ItemTypes.OCEAN_MONUMENT_MAP, ItemTypes.WOODLAND_MANSION_MAP, ItemTypes.BURIED_TRIAL_CHAMBERS_MAP, ItemTypes.JUNGLE_PYRAMID_MAP, ItemTypes.SWAMP_HUT_MAP, ItemTypes.DESERT_VILLAGE_MAP, ItemTypes.PLAINS_VILLAGE_MAP, ItemTypes.SAVANNA_VILLAGE_MAP, ItemTypes.SNOWY_VILLAGE_MAP, ItemTypes.TAIGA_VILLAGE_MAP, ItemTypes.BURIED_TREASURE_MAP, ItemTypes.BURIED_ANCIENT_CITY_MAP, ItemTypes.BURIED_MINESHAFT_MAP, ItemTypes.DESERT_PYRAMID_MAP, ItemTypes.ABANDONED_CAMP_MAP, ItemTypes.WARM_OCEAN_RUINS_MAP);
        ItemTags.EXTENDABLE_MAPS.add(ItemTypes.FILLED_MAP);
        ...
        ItemTags.CUSHIONS.add(ItemTypes.WHITE_CUSHION, ItemTypes.ORANGE_CUSHION, ItemTypes.MAGENTA_CUSHION, ItemTypes.LIGHT_BLUE_CUSHION, ItemTypes.YELLOW_CUSHION, ItemTypes.LIME_CUSHION, ItemTypes.PINK_CUSHION, ItemTypes.GRAY_CUSHION, ItemTypes.LIGHT_GRAY_CUSHION, ItemTypes.CYAN_CUSHION, ItemTypes.PURPLE_CUSHION, ItemTypes.BLUE_CUSHION, ItemTypes.BROWN_CUSHION, ItemTypes.GREEN_CUSHION, ItemTypes.RED_CUSHION, ItemTypes.BLACK_CUSHION);
        ...
        ItemTags.BREWING_POTION_INPUTS.add(ItemTypes.POTION, ItemTypes.SPLASH_POTION, ItemTypes.LINGERING_POTION, ItemTypes.GLASS_BOTTLE);
        ItemTags.FURNACE_FUEL_BOTTOM_TAKEABLE.add(ItemTypes.WATER_BUCKET, ItemTypes.BUCKET);
        ...
        ItemTags.BOATS.addTag(ItemTags.CHEST_BOATS).add(ItemTypes.OAK_BOAT, ItemTypes.SPRUCE_BOAT, ItemTypes.BIRCH_BOAT, ItemTypes.JUNGLE_BOAT, ItemTypes.ACACIA_BOAT, ItemTypes.DARK_OAK_BOAT, ItemTypes.PALE_OAK_BOAT, ItemTypes.MANGROVE_BOAT, ItemTypes.BAMBOO_RAFT, ItemTypes.CHERRY_BOAT, ItemTypes.POPLAR_BOAT);
        ...
        ItemTags.DOUSES_CAMPFIRES.addTag(ItemTags.SHOVELS);
        ...
        copy(BlockTags.ORES, ItemTags.ORES);
