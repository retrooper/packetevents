...
public final class SulfurCubeArchtypes {
    ...
    public static final SulfurCubeArchtype BOUNCY = REGISTRY.define("bouncy", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype EXPLOSIVE = REGISTRY.define("explosive", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype FAST_FLAT = REGISTRY.define("fast_flat", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype FAST_SLIDING = REGISTRY.define("fast_sliding", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype HIGH_RESISTANCE = REGISTRY.define("high_resistance", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype HOT = REGISTRY.define("hot", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype LIGHT = REGISTRY.define("light", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype REGULAR = REGISTRY.define("regular", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype SLOW_BOUNCY = REGISTRY.define("slow_bouncy", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype SLOW_FLAT = REGISTRY.define("slow_flat", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype SLOW_SLIDING = REGISTRY.define("slow_sliding", sulfurCubeArchtypeBuilder()
    ...
    public static final SulfurCubeArchtype STICKY = REGISTRY.define("sticky", sulfurCubeArchtypeBuilder()
