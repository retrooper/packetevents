...
@NullMarked
public class NeoForgeProtocolManager extends ProtocolManagerAbstract {

    private final boolean invert;

    public NeoForgeProtocolManager(Dist environment) {
        this.invert = environment == Dist.CLIENT;
    }
