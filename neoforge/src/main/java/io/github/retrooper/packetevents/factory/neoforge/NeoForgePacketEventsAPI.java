...
package io.github.retrooper.packetevents.factory.neoforge;
...
@NullMarked
public abstract class NeoForgePacketEventsAPI extends PacketEventsAPI<ModList> {
    ...
    public NeoForgePacketEventsAPI(String modId, Dist environment) {
        this(modId, environment, new PacketEventsSettings());
    }

    public NeoForgePacketEventsAPI(String modId, Dist environment, PacketEventsSettings settings) {
        this.modId = modId;
        this.environment = environment;
        this.settings = settings;

        this.protocolManager = new NeoForgeProtocolManager(environment);
        this.serverManager = this.constructServerManager();
        this.playerManager = this.constructPlayerManager();
        this.injector = new NeoForgeChannelInjector(environment);
    }
